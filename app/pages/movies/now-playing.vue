...
import { nowPlayingSortOptions } from "~/utils/sortOptions";
...
const {
  ...
  applyFilters,
  clearFilters,
} = useMovies("/api/movies/now_playing", "release_date.desc", 0, "now_playing");
onMounted(() => {
  fetchMovies();
});
</script>
...
<template>
  <div class="main-background min-h-screen text-white">
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-4xl font-bold mb-8">Now Playing Movies</h1>

      <div class="flex gap-8">
        <div class="w-72 flex-shrink-0">
          <MovieSort
            v-model="sortBy"
            :options="nowPlayingSortOptions"
            @change="applyFilters"
          />
