...
import { upcomingSortOptions } from "~/utils/sortOptions";
...
const {
  ...
  applyFilters,
  clearFilters,
} = useMovies("/api/movies/upcoming", "release_date.asc", 0, "upcoming");

watch(movies, (val) => {
  console.log("movies changed:", val);
});
...
<template>
  <div class="main-background min-h-screen text-white">
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-4xl font-bold mb-8">Upcoming Movies</h1>
